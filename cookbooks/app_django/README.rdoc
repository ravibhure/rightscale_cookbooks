...
Python 2.6.8 (2012-04-12) (x86_64-linux)
...
1 - For apps with bundler support, add the "install_required app python_modules" recipe, and
"run_custom_python_commands" for migration commands

2 - For apps without bundler support, add "install_custom_python_modules" recipe, and
"run_custom_python_commands" for migration commands
...
* <tt>settings.erb</tt> - Configuration for project database connection config file used in the <tt>app::setup_db_connection</tt> recipe
